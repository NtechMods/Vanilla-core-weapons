    ...
    partial class Weapons
    {
        WeaponDefinition SmallMissileTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDefinition
            {
                ...
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: true, rotateRate: 0.01f, elevateRate: 0.01f, minAzimuth: -180, maxAzimuth: 180, minElevation: -8, maxElevation: 90, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, inventorySize: 0.12f, debug: false),
