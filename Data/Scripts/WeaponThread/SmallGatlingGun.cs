    ...
    partial class Weapons
    {
        WeaponDefinition SmallGatlingGun => new WeaponDefinition
        {
            Assignments = new ModelAssignments
            {
                MountPoints = new[]
                {
                    MountPoint(subTypeId: "SmallGatlingGun", aimPartId:"", muzzlePartId: "Barrel", azimuthPartId: "None", elevationPartId:"None"),
                },
            ...
            HardPoint = new HardPointDefinition
            {
                ...
                Block = AimControl(trackTargets: false, turretAttached: false, turretController: false, primaryTracking: false, rotateRate: 0.00f, elevateRate: 0.00f, minAzimuth: 0, maxAzimuth: 0, minElevation: 0, maxElevation: 0, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, inventorySize: 0.064f, debug: false),
            ...
            DamageScales = new DamageScaleDefinition
            {
                ...
                Armor = Options(armor: 0.5f, light: 0.8f, heavy: 0.2f, nonArmor: 1f),
                Shields = Options(modifier: 1.5f, type: Kinetic), // Types: Kinetic, Energy, Emp or Bypass
