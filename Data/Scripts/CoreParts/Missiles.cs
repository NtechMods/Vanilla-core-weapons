...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition LargeMissileTurretReskin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Missile Turret Reskin", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.5f, // Projectile inaccuracy in degrees.
                AimingTolerance = 4f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Accurate, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released.
        ...
        WeaponDefinition SmallMissileTurretReskin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
