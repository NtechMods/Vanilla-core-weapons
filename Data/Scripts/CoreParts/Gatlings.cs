...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition LargeGatlingTurretReskin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        SpinPartId = "GatlingTurretReskinBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
            ...
            {
                PartName = "Gatling Turret Reskin", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        SpinPartId = "GatlingTurretBarrel", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
