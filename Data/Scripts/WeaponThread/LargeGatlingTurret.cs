    ...
    partial class Weapons
    {
        WeaponDefinition LargeGatlingTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignments
            {
                MountPoints = new[]
                {
                    MountPoint(subTypeId: "LargeGatlingTurret", aimPartId:"", muzzlePartId: "GatlingBarrel", azimuthPartId: "MissileTurretBase1", elevationPartId:"MissileTurretBarrels"),
                },
            ...
            {
                WeaponId = "LargeGatlingTurret", // name of weapon in terminal
                AmmoMagazineId = "NATO_25x184mm",
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: true, rotateRate: 0.02f, elevateRate: 0.02f, minAzimuth: -180, maxAzimuth: 180, minElevation: -20, maxElevation: 80, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, inventorySize: 0.384f, debug: false),
