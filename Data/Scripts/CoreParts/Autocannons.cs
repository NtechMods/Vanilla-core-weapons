        ...
        WeaponDefinition SmallBlockAutocannon => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    ReloadTime = 24, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        ...
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns. Subpart_Boomsticks must be written as Boomsticks.
                        MuzzlePartId = "AutocannonTurret_Barrel", // The subpart where your muzzle empties are located. This is often the elevation subpart. Subpart_Boomsticks must be written as Boomsticks.
                        AzimuthPartId = "AutocannonTurret_Base1", // Your Rotating Subpart, the bit that moves sideways.
                        ElevationPartId = "AutocannonTurret_Barrel",// Your Elevating Subpart, that bit that moves up.
                        DurabilityMod = 0.25f, // GeneralDamageMultiplier, 0.25f = 25% damage taken.
                        IconName = "" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
