...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FireworkBlue => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            {
                ModelName = "\\Models\\Cubes\\Large\\FlareAmmo.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
        ...
        private AmmoDef Flare => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DeaccelTime = 1, // EWAR & Mines only- time to spend slowing down to stop at end of trajectory.  0 is instant stop
                GravityMultiplier = 1f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
