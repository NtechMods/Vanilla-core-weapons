    ...
    partial class Weapons
    {
        WeaponDefinition LargeGatlingTurret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDefinition
            {
                ...
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: true, rotateRate: 0.02f, elevateRate: 0.02f, minAzimuth: -180, maxAzimuth: 180, minElevation: -20, maxElevation: 80, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, inventorySize: 0.34f, debug: false),
